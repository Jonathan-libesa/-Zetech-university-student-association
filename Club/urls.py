...
urlpatterns = [
    ...
    path('club-details/<str:pk>/',views.Clubdetails,name="details"),
    path('club-Events/<str:club>/',views.Clubevent,name="Clubevent"),
    ...
    path('participants/<str:pk>/',views.groupfollower,name="followers"),
